...
def identity_initializer(scale = 1.0):
    ...
    def _initializer(shape, dtype=tf.float32):
        print('Warning, you have opted to use the identity_initializer')
        if len(shape) == 1:
...
def orthogonal_initializer(scale = 1.1):
    ...
    '''
    print('Warning -- You have opted to use the orthogonal_initializer function, but not _initializer')
    def _initializer(shape, dtype=tf.float32):
      print('Warning, you have opted to use the orthogonal_initializer, specifically _initializer. Building orthogonal matrices will take some time!')
    ...
    print('you used orthogonal_initializer!!!!')
    return _initializer